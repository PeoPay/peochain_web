...
export function TokenomicsDiagram({
              ...
              >
                ...
                <Legend
                  ...
                  formatter={(value, entry, index) => {
                    ...
                    const item = distributionData[index || 0];
      ...
      <div className="w-full h-full">
        <div className="max-w-3xl mx-auto">
          <div className="w-full flex flex-col">
            ...
            <div className="w-full mx-auto" style={{ height: isMobile ? "400px" : "440px" }}>
              <ResponsiveContainer width="100%" height="100%">
                <LineChart
                  data={filteredData}
                  margin={{
  ...
  const renderMetricsChart = () => {
    // Create formatter for large values
    ...
    return (
      <div className="w-full h-full">
        <div className="max-w-3xl mx-auto">
          {/* Using tables for better metric display on mobile */}
          {isMobile ? (
            ...
            // Desktop view with enhanced bar chart
            <div className="w-full mx-auto" style={{ height: "480px" }}>
              <ResponsiveContainer width="100%" height="100%">
                <BarChart
                  data={displayData}
                  layout="vertical"
                  margin={{
                    top: 25,
                    right: 190, // Increased right margin for labels
                    left: 240, // Increased left margin for names
                    bottom: 45,
                  }}
                >
                  <CartesianGrid strokeDasharray="3 3" stroke="rgba(90, 131, 100, 0.15)" />
                  ...
                  <YAxis
                    ...
                    tickLine={false}
                    axisLine={false}
                    width={230} // Increased for longer names
                    tick={{
                      fontSize: 12,
                      fontWeight: 500,
                      width: 220,
                  ...
                  />
                  <Tooltip
                    formatter={(value) => [enhancedFormatter(value as number), "Tokens"]}
                    contentStyle={{
                      fontSize: "12px",
                      fontWeight: 500,
                      borderRadius: "6px",
  ...
  // Return appropriate chart based on mode prop
  switch (mode) {
    case "distribution":
